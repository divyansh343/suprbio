...
const Themes = () => {
  return (
    <>
      <div className="pt-8 mt-28 bg-gradient-to-r
    from-base-200
    via-base-300
    to-accent background-animate overflow-hidden">
        <div className="container m-auto px-6  md:px-12">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl tracking-normal text-primary font-semibold leading-tight md:leading-tight">Theme which suits to your Profile</h2>
          </div>
          <section className="p-6 my-6 dark:bg-gray-800 dark:text-gray-100">
            <div className=" grid grid-flow-col grid-rows-2 gap-6 px-6 py-2 -mx-4 md:mx-2 md:px-0 md:grid-rows-2 overflow-x-scroll scroll-smooth ">
              {
                options.map(item => (<>
                  <div className="rounded-lg cursor-pointer relative duration-200 w-36 md:w-40 group overflow-hidden">
