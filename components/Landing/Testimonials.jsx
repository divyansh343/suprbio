...
const Testimonials = () => {
  return (
    <>
      <section class="py-12 bg-base-100 sm:py-16 lg:py-20">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="flex flex-col items-center">
            <div class="text-center grid place-items-center ">
              <p class="text-lg font-medium font-pj">2,157 people have said how Suprr Link useful</p>
              ...
              {/* <h2 class="mt-4 text-3xl font-bold  sm:text-4xl xl:text-5xl font-pj">Our happy clients say about us</h2> */}
            </div>
            ...
            <div class="relative mt-10 md:mt-24 md:order-2">
              <div class="absolute -inset-x-1 inset-y-16 md:-inset-x-2 md:-inset-y-6">
                <div class="w-full h-full max-w-5xl mx-auto rounded-3xl opacity-30 blur-lg filter testimonial"></div>
              </div>
              ...
              <div class="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
                <div class="flex flex-col overflow-hidden shadow-xl">
                  <div class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                    ...
                    <div class="flex items-center mt-8">
                      <Image height={50} width={50} class="flex-shrink-0 object-cover rounded-full w-11 h-11" src="https://cdn.rareblocks.xyz/collection/clarity/images/testimonial/4/avatar-male-1.png" alt="" />
                      <div class="ml-4">
                ...
                <div class="flex flex-col overflow-hidden shadow-xl">
                  <div class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                    ...
                    <div class="flex items-center mt-8">
                      <Image height={50} width={50} class="flex-shrink-0 object-cover rounded-full w-11 h-11" src="https://cdn.rareblocks.xyz/collection/clarity/images/testimonial/4/avatar-male-2.png" alt="" />
                      <div class="ml-4">
                ...
                <div class="flex flex-col overflow-hidden shadow-xl">
                  <div class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                    ...
                    <div class="flex items-center mt-8">
                      <Image height={50} width={50} class="flex-shrink-0 object-cover rounded-full w-11 h-11" src="https://cdn.rareblocks.xyz/collection/clarity/images/testimonial/4/avatar-female.png" alt="" />
                      <div class="ml-4">
