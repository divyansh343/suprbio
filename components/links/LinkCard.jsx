...
const LinkCard = ({ item }) => {
  return (
    <>
      <a className="card cursor-pointer glass bg-base-200 hover:bg-base-300 duration-200 space-y-1 p-3 group hover:scale-[1.02]" href={item?.url} target="_blank" rel='noreferrer'>
