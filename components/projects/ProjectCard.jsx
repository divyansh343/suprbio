...
const ProjectCard = ({ item }) => {
  return (
    <a class="card cursor-pointer bg-base-200 hover:bg-base-300 duration-200 space-y-1 p-4 group hover:scale-[1.02]" href={item?.link} target="_blank" rel='noreferrer'><div class="flex items-center gap-2 flex-wrap">
      ...
      <div class=" flex gap-2">
        <span class="badge badge-sm whitespace-nowrap badge-info animate-pulse">
          {item?.status}
        </span>
      </div>
    </div>
